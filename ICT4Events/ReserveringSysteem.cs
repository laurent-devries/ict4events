    ...
    public partial class ReserveringSysteem : Form
    {
        ...
        private void btn_Confirm_user_Click(object sender, EventArgs e)
        {
            ...
            CampingPlace p = cbPlaces.SelectedItem as CampingPlace;
            {
                ...
                conn.InsertOrUpdate("INSERT INTO ICT4_RESERVATION (id_reservation,id_eventFK,id_campingPlaceFK,startDate,endDate,paymentState) VALUES(RESERVATION_SEQ.NEXTVAL," + Convert.ToString(a.ID_Event) + ", " + Convert.ToString(p.IdCampingPlace) + ", to_date(" + Convert.ToString(dtpAankomst.Value) + ", 'dd-mm-yyyy'), to_date(" + Convert.ToString(dtpVertrek.Value) + ", 'dd-mm-yyyy'), 'N'");
